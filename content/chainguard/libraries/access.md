...
Environment variable use for username and password is more secure than
...
Combine the call with `eval` to populate the environment variables directly from
calling `chainctl`:
...
tool configuration with environment variable places holders:
